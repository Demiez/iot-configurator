...
export class DataSourceDataModel extends Identifier implements IDataSource {
  public name: string;
  public port: number;
  ...
  constructor(dataSource: IDataSource) {
    super();
    const { name, port, type, isDefault, isPrimary } = dataSource;

    this.populateIds(dataSource);
