...
export class ErrorCodes extends BaseErrorCodes {
  ...
  public static get INCOMING_REQUESTS_FORBIDDEN(): string {
    return 'INCOMING_REQUESTS_FORBIDDEN';
  }

  public static get IMPORT_ERROR(): string {
    return 'IMPORT_ERROR';
  }

  public static get INVALID_IMPORT_DATA(): string {
    return 'INVALID_IMPORT_DATA';
  }
}
